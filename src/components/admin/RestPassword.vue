                ...
                <div>
                    <el-row>
                        <el-col :span="12">
                            ...
                            :prefix-icon="Avatar" type="text" placeholder="输入账号,重置为初始密码"/></el-col>
            ...
            <el-collapse-item title="账号密码重置" name="2">
                <div>
                    <el-row>
                        <el-col :span="12">
                            <el-input v-model="number"
                            :prefix-icon="Avatar" style="margin-bottom: 15px;" type="text" placeholder="输入账号"/>
                            <el-input v-model="password1"
                            :prefix-icon="Lock" style="margin-bottom: 15px;" type="password" placeholder="输入新密码"></el-input>
                            <el-input v-model="password2"
                            :prefix-icon="Lock" type="password" placeholder="确认密码"></el-input>
                        </el-col>
                    </el-row>
                    <el-row style="margin-top: 15px;">
                        <el-col :span="4" :offset="3">
                            <el-button @click="updatePw1(number,password1,password2)" style="margin-left: 20px;" type="warning">
                                <el-icon><Setting /></el-icon>
                            重置密码</el-button>
                        </el-col>
                    </el-row>
