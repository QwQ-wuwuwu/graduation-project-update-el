                ...
                <el-form :model="processR" style="margin-top: 15px; margin-left: 30px;">
                    ...
                    <el-row :gutter="10">
                        ...
                        <el-col :span="6">
                            ...
                            type="success"
                            :disabled="!(processItemR.name && processItemR.point)">添加阶段项目</el-button>
                        </el-col>
                    ...
                    <el-row :gutter="10" style="margin-top: 15px;">
                        ...
                        <el-col :span="6">
                            ...
                            @click="addStuAttach"
                            type="success"
                            :disabled="!processAttachR.name">添加附件信息</el-button>
                        </el-col>
                        <el-text type="success" style="margin-left: 15px">
                            阶段信息：{{ processR }}
                        </el-text>
                    </el-row>
